            ...
            <div class="agileinfo-ads-display col-lg-9">
                <div class="wrapper">
                    ...
                    <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                        <h3 class="heading-tittle text-center font-italic">Televisions</h3>
                        <div class="row">

                            <?php if (!empty($products_tivi)): ?>
                                <?php foreach ($products_tivi as $product):
                    ...
                    <div class="range border-bottom py-2">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <a href="danh-sach-san-pham/Televisions" class="btn btn-default">Xóa
                                    filter</a>
                            </div>
                        </form>
                    </div>
